...
class RtreeSecIndexReader : public BlockBasedTable::IndexReaderCommon {
 public:
  ...
  size_t ApproximateMemoryUsage() const override {
    ...
    usage += malloc_usable_size(const_cast<RtreeSecIndexReader*>(this));
#else
    usage += sizeof(*this);
 ...
 private:
  RtreeSecIndexReader(const BlockBasedTable* t,
