...
class OneDRtreeSecIndexReader : public BlockBasedTable::IndexReaderCommon {
 public:
  ...
  size_t ApproximateMemoryUsage() const override {
    ...
    usage += malloc_usable_size(const_cast<OneDRtreeSecIndexReader*>(this));
#else
    usage += sizeof(*this);
 ...
 protected:
  ...
  InternalIterator* meta_index_iterator_;

 private:
  OneDRtreeSecIndexReader(const BlockBasedTable* t,
